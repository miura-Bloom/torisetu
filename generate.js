...
const members = [
  ...
  },
  {
    ...
    office: '本社',
    called_short: '堀之内さん',
    called_full: '堀之内さん　呼びやすい呼び方で呼んでください',
    type: 'エミアブル（協調型）',
  ...
  },
  {
    ...
    office: '本社',
    called_short: '部長',
    called_full: '「部長」と呼んでください。入社してから少しずつ評価いただき上がってきた役職です。これからも役職名以上に頑張ります。',
    type: 'ドライバースタイル（主導型）',
  ...
  },
  {
    ...
    office: '本社',
    called_short: '亮一社長',
    called_full: '亮一社長。会長や喜人がいるので西原社長と呼ばれるよりは下の名前で呼ばれたいです。',
    type: 'アナリティカル（分析型）',
  ...
  },
  {
    ...
    name: '長 祐介',
    office: '本社',
    called_short: '長さん・長くん',
    called_full: '「長さん、長くん」と呼ばれると嬉しいです。逆にそれ以外で呼ばれたことがないです。',
    type: 'ドライバー（主導型）',
  ...
  },
  {
    ...
    name: '中武 慎援',
    office: '宮崎営業所',
    called_short: '中武係長・中武さん',
    called_full: '中武係長 / 中武さん',
    type: 'アナリティカル（分析型）',
  ...
  },
  {
    ...
    office: '宮崎営業所',
    called_short: '西川所長',
    called_full: '西川所長でお願いします。初めての社会に出ての生活で不安もあると思いますが、気軽に話してくれたら嬉しいです。',
    type: 'ドライバー（主導型）',
  ...
  },
  {
    ...
    name: '久保 智史',
    office: '山口営業所',
    called_short: '久保さん・久保主任',
    called_full: '久保さん。久保主任。こだわりはありませんが、役職名だけで呼ばれるのは好きではないです。',
    type: 'エクスプレッシング（表現型）',
  ...
  },
  {
    ...
    office: '山口営業所',
    called_short: '田中所長',
    called_full: '田中所長。自分も中途採用ではありますが18歳からフレッシュ青果にお世話になり現在の役職まで評価いただきました。気軽に声かけて下さい。',
    type: 'アナリティカル（分析型）',
  ...
  },
  {
    ...
    office: '東海静岡営業所',
    called_short: '所長・たかし',
    called_full: '営業所の皆さんからは「所長」と気軽に呼ばれています。上司の方からは「たかし」と呼ばれる事が多く、親近感があって嬉しいですね！',
    type: 'ドライバー（主導型）',
  ...
  },
  {
    ...
    office: '東海名古屋営業所',
    called_short: '所長',
    called_full: '【所長】と気軽に呼んでもらえると嬉しいです。人と話すことが好きなので仕事の話以外でも気軽に話しかけて下さい。',
    type: 'エミアブル（協調型）',
    type_desc: '普段から人との関係性や安心感を大切にしているので、従業員ひとりひとりの話をよく聞くことを意識しています。',
  ...
  },
  {
    ...
    name: '松元 琢也',
    office: '大分営業所',
    called_short: '松元所長・たくや',
    called_full: '「松元所長」と呼んでもらえるといいです。上司からは「たくや」と呼ばれます。',
    type: 'エクスプレッシブ（表現型）',
  ...
  },
  {
    ...
    name: '櫻井 拓実',
    office: '大分営業所',
    called_short: 'たくみ・たくちゃん',
    called_full: 'たくみ / たくちゃん。あえて、下の名前で呼んでもらいフレンドリーな感じで会話ができると思います。',
    type: '協調型（エシアブル）',
  ...
  },
  {
    ...
    office: '岡山営業所',
    called_short: '所長・西所長',
    called_full: '所長または西所長ですかね。名字は西と短いので覚えやすいとおもいますよ。',
    type: '協調型',
  ...
  },
  {
    ...
    name: '西原 喜人',
    office: '長崎営業所',
    called_short: '喜人所長・喜人部長',
    called_full: '【喜人所長】もしくは【喜人部長】でお願いします。人と話しするのは好きなので、気軽に話しかけていただけると嬉しいです。',
    type: 'エミアブル（協調型）',
    type_desc: '人との関係性や安心感を大切にしており、相手の話をよく聞くことを意識しています。',
...
<div class="content">
  ...
  <div class="section">
    <div class="section-label">A-1</div>
    <div class="section-title">🏷️ 呼ばれたい名前</div>
    <div class="section-body">${m.called_full}</div>
  </div>
